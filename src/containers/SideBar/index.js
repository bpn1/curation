...
import { layoutBreakpoint } from '../../layout.js';
...
class SideBar extends Component {
    render() {
        ...
        const sideBarStyle = window.matchMedia(layoutBreakpoint).matches ?
              ...
              overlayClass = !window.matchMedia(layoutBreakpoint).matches && this.props.showSideNav ?
        ...
        return (
            ...
            <div className={overlayClass} onClick={() => this.props.toggleSideNav()} />
                ...
                >
                      {window.matchMedia(layoutBreakpoint).matches ? null : <div className={styles.avatarContainer}> <Avatar size={80} src={image} /> </div> }
